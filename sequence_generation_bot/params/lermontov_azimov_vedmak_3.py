...
ps = dict(
        description='Хорошо обученная модель.',
        default_model_href='https://drive.google.com/open?id=1i8LcQLMEOHJ8-mwLKEZTZ9F3egrgR9Sw',
        ...
        default_model_name='model_sgnn-v11.2',
